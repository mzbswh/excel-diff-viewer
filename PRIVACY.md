...
Visual Studio Code, the extension marketplace, and package installation tools have their own privacy policies and may perform network operations independently of Excel Diff Viewer.
