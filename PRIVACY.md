...
The extension stores only the URI of the workbook selected through **Select for Compare** in VS Code workspace state. Use **Excel Diff: Clear Selected File** to remove that value.
