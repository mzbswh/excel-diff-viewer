...
Use [GitHub Issues](https://github.com/mzbswh/excel-diff-viewer/issues) for bug reports and feature requests.
...
Do not attach confidential workbooks or credentials to a public issue.

For security vulnerabilities, follow [SECURITY.md](SECURITY.md) instead of posting sensitive details publicly.
